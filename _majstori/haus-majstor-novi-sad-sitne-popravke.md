...
sections:
- type: p
  content: U Novom Sadu, gde <em>prekidač ne radi, a police čekaju na zid</em> – <strong>Haus
    Majstor</strong> dolazi tačno na vreme. 20+ godina iskustva, pun gepek alata i
    <em>javan cenovnik</em> – sve što vam treba za miran dom.
- type: p
...
- type: p
  content: Tim sa <strong>više od dve decenije iskustva</strong>. Imaju sve alate,
    dolaze tačno, rade čisto – i vole ono što rade.
- type: p
...
- type: p
  content: 'Od elektrike do vodovoda:'
- type: h3
  content: 1. Elektro Radovi
- type: p
  content: Zamena osigurača, prekidača, utičnica, lustera, provera instalacija.
- type: h3
  content: 2. Vodoinstalaterski Radovi
- type: p
  content: Popravka vodokotlića, zamena sifona, punjenje grejanja.
- type: h3
  content: 3. Montaža i Kačenje
- type: p
  content: TV na zid, police, garnišne, slike, vrata.
- type: h3
  content: 4. Nameštaj i Podovi
- type: p
  content: Sastavljanje, rastavljanje, postavljanje laminata.
- type: h3
  content: 5. Sitne Popravke
- type: p
  content: Šarke, brave, bušenje, popravka aparata.
- type: h2
...
- type: ul
  items:
  - "<strong>Veternik, Futog</strong> – elektrika i vodovod"
  - "<strong>Petrovaradin, Sremska Kamenica</strong> – montaža nameštaja"
  - "<strong>Rumenka, Kać</strong> – kačenje i bušenje"
  - "<strong>Beočin, Temerin</strong> – laminat i vrata"
  - "<strong>Bački Petrovac</strong> – sitne popravke"
- type: h2
  content: Kako Funkcioniše Saradnja sa Haus Majstorom
- type: p
  content: "<strong>1. Poziv ili email</strong> – opišete problem<br><strong>2. Dogovor</strong>
    – tačno vreme, cena sa sajta<br><strong>3. Dolazak</strong> – pun alat, uredno<br><strong>4.
    Rad</strong> – brzo, čisto, stručno<br><strong>5. Gotovo</strong> – plaćate po
    cenovniku"
- type: h2
  content: Zašto Haus Majstor – Ključne Prednosti
- type: ul
  items:
  - Javan cenovnik – bez iznenađenja
  - 20+ godina iskustva – znaju šta rade
  - Tačnost – dolaze kad kažu
  - Sve alate nose – vi ne morate ništa
  - Čisto posle rada – nema šuta
  - 4.6★ na Google – korisnici preporučuju
- type: p
...
- title: Vodoinstalaterski Radovi
  description: Vodokotlić, sifon, grejanje.
- title: Montaža i Kačenje
  description: TV, police, garnišne, slike, vrata.
- title: Nameštaj i Podovi
  description: Sastavljanje, laminat, šarke.
- title: Sitne Popravke
  description: Bušenje, brave, aparati.
faq:
- question: Imate li cenovnik?
  answer: Da, javan na sajtu sitnepopravke.com
- question: Dolazite li tačno?
  answer: Da, u dogovoreno vreme – bez čekanja.
- question: Imate li alat?
  answer: Da, sve profesionalno – vi ne morate ništa.
- question: Radite li vikendom?
  answer: Da, po dogovoru – bez doplate.
- question: Koliko košta zamena utičnice?
  answer: Pogledajte cenovnik na sajtu – tačna cena.
- question: Kako da vas kontaktiram?
  answer: Email kontakt@majstor.info ili telefon +381 61 22 11 700
tips:
- Redovna provera osigurača – sprečava havarije
- Automatski osigurači – sigurnost za decu i aparate
- Bušenje u pločice – dijamantska kruna, bez pucanja
- Kačenje TV-a – nosivost zida prvo proverite
- Laminat preko starog poda – ušteda na rušenju
